...
const ja: Messages = {
  ...
  questions: {
    '1': '基礎をマスターする',
    '2': '言葉を起動し照らす',
    '3': '痛みを見つけてエネルギーを収縮させる',
    '4': '何を望んでいるのかを定義してください',
    '5': '欲しいものを書き出してください',
    '6': '他人に夢を話さないでください',
    '7': '目標への強い願望を持ちましょう',
    '8': 'ゴールはスイートスポットでなければなりません',
    '9': '決断を下す',
    '10': '目標を達成していることに満足感を得てください',
    '11': '結果への執着を解放する',
    '12': '「どうやって」が自然に現れるかを許しましょう',
    '13': 'DreamとChief Aimの違いを知る',
    '14': '集中しろ / 目的の一者性',
    '15': '日々のTODO優先事項リスト',
    '16': 'チャートの進捗 / スコアを知ろう',
    '17': '成功の勢いサイクルを活用しましょう',
    '18': 'ドリームビルド - ドリームブック&ビジョンボード',
    '19': 'システムへの接続',
    '20': '個人習熟科学コース',
    '21': '話す言葉に気をつけてください。言ったことが結果になります',
    '22': '成功のための生理学/服装',
    '23': '明確な反意',
    '24': '内なる力を目覚めさせよう:スーパーパワーのプロセス',
    '25': 'アルファシータ脳波での放送',
    '26': '悲しみの話をやめなさい',
    '27': '感謝の気持ちを示す',
    '28': '失敗の習慣を成功の習慣に置き換える(加速プロセス)',
    '29': 'マスターマインドを作る',
    '30': '成功した人々/見習いを見よう',
    '31': '成功体験談を聞く/読む',
    '32': 'まずは欲しいものをあげてください',
    ...
    '34': '体を大切にしてください',
    '35': '逆境の中で金を見つけよう',
    '36': 'フィールドからのクリアなサンスカラ',
    '37': '100%の責任を負いましょう',
    '38': 'アトラクターフィールドジェネレーター',
    '39': 'パワーソースとつながるクラブに参加しましょう',
    '40': '意図的に生きること - 今この瞬間に集中しましょう',
    '1a': '誰の話を聞くの?',
    '1b': '教える可能性指数',
    '1c': 'トレーニングバランススケール',
    '1d': '無意識の能力',
