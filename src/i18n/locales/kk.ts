...
const kk: Messages = {
  ...
  questions: {
    '1': 'Негіздерді меңгеру',
    '2': 'Сөздерді іске қосу және жарықтандыру',
    '3': 'Ауырсынуды табу және энергияны қысқарту',
    '4': 'Не қалайтыныңды анық айт',
    '5': 'Қалағаныңды жаз',
    '6': 'Арманыңызды басқалармен бөліспеңіз',
    '7': 'Мақсатыңа қатты құштарлық сезін',
    '8': 'Гол Sweet Spot-та болуы керек',
    '9': 'Шешім қабылда',
    '10': 'Мақсатыңа жеткенде көр/жақсы сезін',
    '11': 'Нәтижеге байланысты босату',
    '12': 'ҚАЛАЙ көрінсін деп рұқсат етіңіз',
    '13': 'Dream мен Chief Aim арасындағы айырмашылықты біліңіз',
    '14': 'Назар аударыңыз / Мақсаттың біртұтастығы',
    '15': 'Күнделікті TO DO басымдықтар тізімі',
    '16': 'Чарттағы ілгерілеу / Есеп туралы білу',
    '17': 'Импульс Сәттілік Циклін пайдалану',
    '18': 'Dream Build - Армандар кітабы және көрініс тақтасы',
    '19': 'Жүйеге қосылу',
    '20': 'Жеке шеберлік ғылымы курсы',
    '21': 'Айтқан сөздеріңе қара - айтқаның соны аласың',
    '22': 'Физиология / Табысқа арналған киім',
    '23': 'Айқын қарсы ниеттер',
    '24': 'Ішкі күшіңді оят: Суперқуат процестері',
    '25': 'Альфа-тета ми толқынында тарату',
    '26': 'Қайғы туралы әңгімеңді айтуды қой',
    '27': 'Ризашылық білдіру / Алғыс білдіру',
    '28': 'Сәтсіздік әдеттерін табысқа жету әдеттерімен ауыстыру (үдеткіш процестер)',
    '29': 'Мастермайндты жаса',
    '30': 'Successful People/Apprentice-ті көріңіз',
    '31': 'Табыс тарихтарын тыңдаңыз/оқыңыз',
    '32': 'Алдымен қалағаныңды бер',
    '33': 'Қазір жаса деген менталитет',
    '34': 'Денеңе қара',
    '35': 'Қиындықта алтын табу',
    '36': 'Самскараларды алаңнан тазарту',
    '37': '100% жауапкершілікті ал',
    '38': 'Тартқыш өріс генераторлары',
    '39': 'Сізді қуат көзімен байланыстыратын клубқа қосылыңыз',
    '40': 'Өмірді әдейі өмір сүр – қазіргі уақытта бол',
    '1a': 'Кімді тыңдайсың?',
    '1b': 'Оқытушылық индексі',
    '1c': 'Жаттығу тепе-теңдік шкаласы',
    '1d': 'Бейсаналық қабілет',
    '19a': 'Кітап оқыңыз',
    '19b': 'Аудиоларды тыңдаңыз',
    '19c': 'Қатысу іс-шараларына (ай сайын)',
    '19d': 'Тану беру және алу / кеңейтілген Алтын Ереже',
    '19e': 'Ұқсас ойлы адамдармен қарым-қатынас орнатыңыз',
    '23a': 'Ақша процестері',
    '23b': 'Қатынас процестері',
    '23c': 'Көшбасшылық процестері',
    '23d': 'Коммуникация процестері',
    '23e': 'Денсаулық сақтау процестері',
    '23f': 'Рухани саналы үдерістер',
    '23g': 'Түс процестері',
    '23h': 'Ұйымдастыру және бағыттау процестері'
  }
};
