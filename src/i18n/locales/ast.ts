...
const ast: Messages = {
  ...
  questions: {
    ...
    '2': 'Activar e iluminar palabras',
    '3': 'Encuentre dolor y contraiga energía',
    '4': 'Define lo que quieres',
    '5': 'Escribe lo que quieras',
    '6': 'No compartas tu sueño con los demás',
    '7': 'Obtén un deseo ardiente por tu objetivo.',
    '8': 'El objetivo debe estar en el punto ideal.',
    '9': 'Tomar una decisión',
    '10': 'Ver/Sentirse bien en posesión de tu portería',
    '11': 'Liberar el apego al resultado.',
    '12': 'Permitir que el CÓMO se presente',
    '13': 'Conozca la diferencia entre Dream y Chief Aim',
    '14': 'Estar enfocado / Unicidad de propósito',
    '15': 'Lista diaria de prioridades para hacer',
    '16': 'Progreso del gráfico / Conozca la puntuación',
    '17': 'Utilice el ciclo de éxito del impulso',
    '18': 'Dream Build - Libro de sueños y tablero de visión',
    '19': 'Conectarse al sistema',
    '20': 'Curso de ciencia del dominio personal',
    '21': 'Cuida las palabras que dices: lo que dices es lo que obtienes',
    '22': 'Fisiología / Vestirse para el éxito',
    '23': 'Claras contraintenciones',
    '24': 'Despierta tu poder interior: procesos de superpoderes',
    '25': 'Transmitido en onda cerebral alfa-theta',
    '26': 'Deja de contar tu historia de desgracia',
    '27': 'Mostrar aprecio/gratitud',
    '28': 'Reemplazar hábitos de fracaso con hábitos de éxito (procesos aceleradores)',
    '29': 'Crear un cerebro',
    '30': 'Ver gente exitosa/aprendiz',
    '31': 'Escuche/Lea Historias de Éxito',
    '32': 'Regala primero lo que quieras',
    '33': 'Mentalidad de hacerlo ahora',
    '34': 'Cuida tu cuerpo',
    '35': 'Encuentra el oro en la adversidad',
    '36': 'Limpiar Samskaras del campo',
    '37': 'Asuma el 100% de responsabilidad',
    '38': 'Generadores de campos de atracción',
    '39': 'Únete a un Club que te conecta a una Fuente de Energía',
    '40': 'Vive la vida con intención deliberada: vive el tiempo presente.',
    '1a': '¿A quién escuchas?',
    ...
    '19e': 'Desarrollar relaciones con personas de ideas afines.',
