...
const sl: Messages = {
  ...
  questions: {
    '1': 'Obvladaj osnove',
    '2': 'Aktiviraj in osvetli besede',
    '3': 'Najdi bolečino in skrči energijo',
    '4': 'Določi, kaj želiš',
    '5': 'Zapiši, kaj želiš',
    '6': 'Ne delite svojih sanj z drugimi',
    '7': 'Občuti gorečo željo po svojem cilju',
    '8': 'Cilj mora biti v Sweet Spotu',
    '9': 'Sprejmi odločitev',
    '10': 'Videti/se dobro počutiti, ko imaš svoj cilj',
    '11': 'Sprostite navezanost na rezultat',
    '12': 'Dovolite, da se KAKO pokaže',
    '13': 'Poznajte razliko med Dream in Chief Aim',
    '14': 'Bodite osredotočeni / Enotnost namena',
    '15': 'Dnevni seznam prioritet opravil',
    '16': 'Napredek na lestvicah / Poznajte rezultat',
    '17': 'Uporabite cikel uspeha z zagonom',
    '18': 'Dream Build - Dream Book in Vision Board',
    '19': 'Priklop v sistem',
    '20': 'Tečaj znanosti osebnega mojstrstva',
    '21': 'Pazi, kaj govoriš – kar rečeš, to dobiš',
    '22': 'Fiziologija / Oblačenje za uspeh',
    '23': 'Jasne protinamere',
    '24': 'Prebudite svojo notranjo moč: procesi supermoči',
    '25': 'Oddaja na Alpha-theta možganskih valovih',
    '26': 'Nehaj pripovedovati svojo zgodbo o nesreči',
    '27': 'Pokažite hvaležnost / zahvalo',
    '28': 'Zamenjajte navade neuspeha z navadami uspeha (pospeševalni procesi)',
    '29': 'Ustvarite Mastermind',
    '30': 'Oglejte si Uspešne ljudi/Vajenca',
    '31': 'Poslušajte/preberite zgodbe o uspehu',
    '32': 'Najprej podarite, kar želite',
    '33': "Mentaliteta 'naredi zdaj'",
    '34': 'Skrbite za svoje telo',
    '35': 'Najdi zlato v težavah',
    '36': 'Čisti samskare s polja',
    '37': 'Prevzemi 100 % odgovornost',
    '38': 'Generatorji atraktorskega polja',
    '39': 'Pridruži se klubu, ki te poveže z virom energije',
    '40': 'Živi življenje z namernim namenom – bodi v sedanjosti',
    '1a': 'Koga poslušaš?',
    '1b': 'Indeks učljivosti',
    '1c': 'Lestvica za ravnotežje treninga',
    '1d': 'Nezavedna kompetentnost',
    '19a': 'Beri knjige',
    '19b': 'Poslušajte avdio posnetke',
    '19c': 'Udeležba na dogodkih (mesečno)',
    '19d': 'Priznavanje in prejemanje / razširjeno zlato pravilo',
    '19e': 'Razvijajte odnose z ljudmi s podobnimi interesi',
    '23a': 'Denarni procesi',
    '23b': 'Procesi odnosov',
    '23c': 'Procesi vodenja',
    '23d': 'Komunikacijski procesi',
    '23e': 'Zdravstveni procesi',
    '23f': 'Procesi duhovne zavednosti',
    '23g': 'Sanjski procesi',
    '23h': 'Procesi organizacije in osredotočenosti'
  }
};
