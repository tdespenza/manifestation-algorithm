...
const hy: Messages = {
  ...
  questions: {
    '1': 'Տիրապետեք հիմունքներին',
    '2': 'Ակտիվացնել եւ լուսավորել բառերը',
    '3': 'Գտեք ցավը եւ պայմանագրային էներգիան',
    '4': 'Սահմանեք, թե ինչ եք ուզում',
    '5': 'Գրի՛ր այն, ինչ ուզում ես',
    '6': 'Մի ներկայացրեք ձեր երազանքը մյուսների հետ',
    '7': 'Ձեռք բերեք ձեր նպատակի հանդեպ բորբոքված ցանկություն',
    '8': 'Նպատակը պետք է լինի քաղցր կետում',
    '9': 'Որոշում կայացրեք',
    '10': 'Տեսեք/Լավ զգաք ձեր նպատակին տիրանալիս',
    '11': 'Ազատեք արդյունքի կցորդը',
    '12': 'Թույլ տվեք ԻՆՉՊԵ՞ս ներկայանալ',
    '13': 'Իմացեք տարբերությունը Dream & Chief Aim',
    '14': 'Եղեք կենտրոնացած / Նպատակի միայնակություն',
    '15': 'Ամենօրյա TO DO առաջնահերթությունների ցանկ',
    '16': 'Աղյուսակ Առաջընթաց / Իմացեք գնահատականը',
    '17': 'Օգտագործեք հաջողության մոմենտի ցիկլը',
    '18': 'Երազանքի Կառուցում - Երազանքի գիրք եւ տեսլական խորհուրդ',
    '19': 'Միացնել համակարգին',
    '20': 'Անհատական վարպետության դասընթաց',
    '21': 'Ուշադրություն դարձրեք, թե ինչ բառեր եք ասում, այն, ինչ ստանում եք',
    '22': 'Ֆիզիոլոգիա / Հագուստ հաջողության համար',
    '23': 'Հստակ հակադարձ մտադրություններ',
    '24': 'Արթնացրե՛ք ձեր ներքին ուժը. գերհզոր պրոցեսներ',
    '25': 'Հեռարձակվում է Ալֆա-թետա ուղեղային ալիքով',
    '26': 'Դադարեք պատմել ձեր դժբախտության պատմությունը',
    '27': 'Ցույց տվեք գնահատանք / երախտագիտություն',
    '28': 'Փոխարինել ձախողման սովորությունները հաջողության սովորություններով (արագացուցիչ գործընթացներ)',
    '29': 'Ստեղծել Mastermind',
    '30': 'Դիտել Հաջողակ մարդիկ/Աշակերտ',
    '31': 'Լսել/կարդալ հաջողության պատմությունները',
    '32': 'Նախ տվեք այն, ինչ ուզում եք',
    '33': 'Արա դա հիմա մտածելակերպ',
    '34': 'Հոգ տարեք ձեր մարմնի մասին',
    '35': 'Գտեք ոսկին դժբախտության մեջ',
    '36': 'Մաքրել Սամսկարասը դաշտից',
    '37': 'Վերցրեք 100% պատասխանատվություն',
    '38': 'Գրավիչ դաշտի գեներատորներ',
    '39': 'Միացե՛ք ակումբին, որը ձեզ կապում է էլեկտրաէներգիայի աղբյուրի հետ',
    '40': 'Ապրեք կյանքը կանխամտածված մտադրությամբ, եղեք ներկա ժամանակում',
    '1a': 'Ո՞ւմ եք լսում:',
    '1b': 'Ուսուցման ինդեքս',
    '1c': 'Ուսուցման հաշվեկշիռ սանդղակ',
    '1d': 'Անգիտակցական կոմպետենցիա',
    '19a': 'Կարդալ գրքեր',
    '19b': 'Ունկնդրել աուդիոներ',
    '19c': 'Մասնակցել միջոցառումներին (ամսական)',
    '19d': 'Տալ եւ ստանալ ճանաչում / ընդլայնված ոսկե կանոն',
    '19e': 'Զարգացրեք հարաբերություններ նույն մտածելակերպ ունեցող մարդկանց հետ',
    '23a': 'Դրամական գործընթացներ',
    '23b': 'Հարաբերությունների գործընթացներ',
    '23c': 'Առաջնորդության գործընթացներ',
    '23d': 'Հաղորդակցման գործընթացներ',
    '23e': 'Առողջապահական գործընթացներ',
    '23f': 'Հոգեւոր գիտակցության գործընթացներ',
    '23g': 'Երազանքի գործընթացներ',
    '23h': 'Կազմակերպման եւ ֆոկուս գործընթացներ'
  }
};
