...
const lb: Messages = {
  ...
  questions: {
    '1': "Meeschter d'Grondlage",
    '2': 'Aktivéieren & Luuchten Wierder',
    '3': 'Schwéierpunkte fannen & Energie verknäppe',
    '4': 'Definéiert wat Dir wëllt',
    '5': 'Schreif op wat s du wëlls',
    '6': 'Deel deng Dreem net mat aneren',
    '7': 'Kritt e brennende Wonsch fir Äert Zil',
    '8': 'De Goal muss am perfekte Beräich sinn',
    '9': 'Maach eng Decisioun',
    '10': 'Fill dech gutt wanns de dengem Zil besëtzens',
    '11': 'Lassloossen vun der Verbindung mam Resultat',
    '12': "Loosst d'Wéi sech weisen",
    '13': 'Kënn de Unterschied tëscht Dram an Haaptziel',
    '14': 'Konzentréiert sinn / Eenheet vu Zweck',
    '15': 'All Dag Prioritéiten-Lëscht',
    '16': 'Diagramm Fortschrëtt / Kennt de Score',
    '17': 'Benotzt de Mommëntum-Ëmsaz vum Erfolleg',
    '18': 'Dreem Bau - Dreem Buch & Visiounsplang',
    '19': "An d'System anschléissen",
    '20': 'Wëssenschaft vum perséinleche Meeschtertum Cours',
    '21': "Kuck de Wierder no, déi's de schwätz – wat's de sees, kritt's de.",
    '22': 'Physiologie / Ugedoen fir Erfolleg',
    '23': 'Kloer Géigendeeler Intentionen',
    '24': 'Erliew däi bannent Kraaft: Superkraaft Prozesser',
    '25': 'Iwwerdroe op Alpha-Theta-Gehirnwelle',
    '26': 'Halt op, deng Geschicht vum Leed ze erzielen',
    '27': 'Wäertschätzung / Dankbarkeet weisen',
    '28': 'Ersetze Mëssluechte Gewunnechten duerch Erfolleg Gewunnechten (Beschleuneger Prozesser)',
    '29': 'Schaf eng Mastermind',
    '30': 'Kuckt Erfollegräich Leit/Léierjong',
    '31': 'Nolauschteren/Nokucke Erfollegsgeschichten',
    '32': 'Ginn ewech wat Dir als éischt wëllt',
    '33': 'Maach et elo Mentalitéit',
    '34': 'Këmmer dech ëm däi Kierper',
    '35': 'Fannt dat Gold an der Géignerfar',
    '36': 'Kloer Samskaras vum Feld',
    '37': 'Huelt 100% Verantwortung',
    '38': 'Attraktor Feld Generatore',
    '39': 'Gitt engem Club bäi, deen Iech mat enger Kraaftquell verbënnt',
    '40': "Liewen d'Liewen mat bewosster Absicht - sinn am aktuellen Moment",
    '1a': 'Op wien lauschtere mir?',
    '1b': 'Léierbarkeetsindex',
    '1c': 'Trainingsbalanceskal',
    '1d': 'Onbewosst Fäegkeet',
    '19a': 'Lies Bicher',
    '19b': 'Nolauschtert Audioen',
    '19c': 'Un Evenementer deelhuelen (monatläch)',
    '19d': 'Gëtt an empfänkt Unerkennung / erweidert Goldene Regel',
    '19e': 'Entwéckelt Bezéiunge mat Mënschen, déi ähnlech denken',
    '23a': 'Geldprozesser',
    '23b': 'Bezéiungsprozesser',
    '23c': 'Féierungsprozesser',
    '23d': 'Kommunikatiounsprozesser',
    '23e': 'Gesondheetsprozesser',
    '23f': 'Geeschteg Bewosstsinn Prozesser',
    '23g': 'Dreemprozesser',
    '23h': 'Organisatioun & Fokusprozesser'
  }
};
