...
const nl: Messages = {
  ...
  questions: {
    '1': 'Beheers de basis',
    '2': 'Activeer & Verlicht Woorden',
    '3': 'Vind Pijn & Contractenergie',
    '4': 'Definieer wat je wilt',
    '5': 'Schrijf op wat je wilt',
    '6': 'Deel je droom niet met anderen',
    '7': 'Krijg een brandend verlangen naar je doel',
    '8': 'Het doel moet in Sweet Spot liggen',
    '9': 'Neem een beslissing',
    '10': 'Zie of voel je goed in het bezit van je doel',
    '11': 'Laat de aanhechting aan het resultaat los',
    '12': 'Laat het HOE zich manifesteren',
    '13': 'Ken het verschil tussen Dream en Chief Aim',
    '14': 'Wees gefocust / Single-zijn van doel',
    '15': 'Dagelijkse TO DO-lijst met prioriteiten',
    '16': 'Voortgang van de hitlijsten / Ken de score',
    '17': 'Gebruik de momentumcyclus van succes',
    '18': 'Dream Build - Droomboek & Visiebord',
    '19': 'Aansluiten op Systeem',
    '20': 'Cursus Wetenschap van Persoonlijke Beheersing',
    '21': 'Let op de woorden die je zegt - wat je zegt is wat je krijgt',
    '22': 'Fysiologie / Kleed je voor succes',
    '23': 'Duidelijke tegenintenties',
    '24': 'Ontwaak je innerlijke kracht: Superkrachtprocessen',
    '25': 'Uitzending op Alpha-theta hersengolf',
    '26': 'Stop met het vertellen van je ellendige verhaal',
    '27': 'Toon waardering / dankbaarheid',
    '28': 'Vervang faalgewoonten door succesgewoonten (Acceleratorprocessen)',
    '29': 'Creëer een Mastermind',
    '30': 'Bekijk Succesvolle Mensen/Leerling',
    '31': 'Luister naar/lees succesverhalen',
    '32': 'Geef eerst wat je wilt weg',
    '33': 'Doe het nu-mentaliteit',
    '34': 'Zorg goed voor je lichaam',
    '35': 'Vind het goud in tegenspoed',
    '36': "Maak Samskara's uit het veld vrij",
    '37': 'Neem 100% verantwoordelijkheid',
    '38': 'Attractorveldgeneratoren',
    '39': 'Word lid van een club die je verbindt met een energiebron',
    '40': 'Leef het leven met een bewuste intentie - wees in het heden',
    '1a': 'Naar wie luister je?',
    '1b': 'Onderwijsindex',
    '1c': 'Trainingsbalans Weegschaal',
    '1d': 'Onbewuste competentie',
    '19a': 'Lees boeken',
    '19b': "Luister naar audio's",
    '19c': 'Woon evenementen bij (maandelijks)',
    '19d': 'Erkenning geven en ontvangen / uitgebreide Gouden Regel',
    '19e': 'Bouw relaties op met gelijkgestemden',
    '23a': 'Geldprocessen',
    '23b': 'Relatieprocessen',
    '23c': 'Leiderschapsprocessen',
    '23d': 'Communicatieprocessen',
    '23e': 'Gezondheidsprocessen',
    '23f': 'Spirituele bewustzijnsprocessen',
    '23g': 'Droomprocessen',
    '23h': 'Organisatie- en focusprocessen'
  }
};
