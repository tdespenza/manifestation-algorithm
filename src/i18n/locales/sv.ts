...
const sv: Messages = {
  ...
  questions: {
    '1': 'Behärska grunderna',
    '2': 'Aktivera och belysa ord',
    '3': 'Hitta smärta och kontrakterad energi',
    '4': 'Definiera vad du vill ha',
    '5': 'Skriv ner vad du vill ha',
    '6': 'Dela inte din dröm med andra',
    '7': 'Känn en brinnande längtan efter ditt mål',
    '8': 'Målet måste vara i Sweet Spot',
    '9': 'Fatta ett beslut',
    '10': 'Se/Känn dig bra med ditt mål',
    '11': 'Släpp fästet vid resultatet',
    '12': 'Låt HUR visa sig',
    '13': 'Känn skillnaden mellan Dream och Chief Aim',
    '14': 'Var fokuserad / Singel i syfte',
    '15': 'Daglig ATT-göra-lista över prioriteringar',
    '16': 'Listframsteg / Känn till poängen',
    '17': 'Använd framgångscykeln i momentum',
    '18': 'Drömbygge - Drömbok & Visionstavla',
    '19': 'Koppla in i systemet',
    '20': 'Kursen i Vetenskap om personlig behärskning',
    '21': 'Var uppmärksam på orden du säger – det du säger är vad du får',
    '22': 'Fysiologi / Klä dig för framgång',
    '23': 'Tydliga motintentioner',
    '24': 'Väck din inre kraft: Superkraftsprocesser',
    '25': 'Sänd på Alpha-theta hjärnvåg',
    '26': 'Sluta berätta din sorgliga historia',
    '27': 'Visa uppskattning / tacksamhet',
    '28': 'Ersätt misslyckanden med framgångsvanor (acceleratorprocesser)',
    '29': 'Skapa en Mastermind',
    '30': 'Titta på Successful People/Apprentice',
    '31': 'Lyssna på/läs framgångshistorier',
    '32': 'Ge bort det du vill ha först',
    '33': 'Gör det nu-mentalitet',
    '34': 'Ta hand om din kropp',
    '35': 'Hitta guldet i motgång',
    '36': 'Rensa Samskaras från fältet',
    '37': 'Ta 100 % ansvar',
    '38': 'Attraktorfältgeneratorer',
    '39': 'Gå med i en klubb som kopplar dig till en kraftkälla',
    '40': 'Lev livet med avsiktlig avsikt – var i nuet',
    '1a': 'Vem lyssnar du på?',
    '1b': 'Undervisningsindex',
    '1c': 'Träningsbalansvåg',
    '1d': 'Omedveten kompetens',
    '19a': 'Läs böcker',
    '19b': 'Lyssna på ljudinspelningar',
    '19c': 'Delta i evenemang (månadsvis)',
    '19d': 'Ge och ta emot Erkännande / utökad Gyllene Regel',
    '19e': 'Utveckla relationer med likasinnade',
    '23a': 'Pengaprocesser',
    '23b': 'Relationsprocesser',
    '23c': 'Ledarskapsprocesser',
    '23d': 'Kommunikationsprocesser',
    '23e': 'Hälsoprocesser',
    '23f': 'Andliga medvetandeprocesser',
    '23g': 'Drömprocesser',
    '23h': 'Organisations- och fokusprocesser'
  }
};
