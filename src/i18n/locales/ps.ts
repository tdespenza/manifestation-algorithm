...
const ps: Messages = {
  ...
  questions: {
    '1': 'بنسټونه زده کړه',
    '2': 'فعاله کړه او کلمې روښانه کړه',
    '3': 'د درد او د انرژۍ تړل پیدا کړئ',
    '4': 'تعریف کړه چې څه غواړې',
    '5': 'هغه څه ولیکه چې غواړې',
    '6': 'خپل خوب له نورو سره مه شریکوئ',
    '7': 'د خپل هدف لپاره یوه سوځنده هیله پیدا کړه',
    '8': 'هدف باید په خوږ ځای کې وی',
    '9': 'پریکړه وکړه',
    '10': 'د خپل هدف په مالکیت کې ښه احساس وکړئ',
    '11': 'د پایلې سره تړاو خوشې کړئ',
    '12': 'اجازه ورکړه چې څنګه ځان وړاندې کړی',
    '13': 'د Dream او Chief Aim ترمنځ توپیر وپېژنئ',
    '14': 'تمرکز وکړئ / د هدف یوازیتوب',
    '15': 'د ورځنیو کارونو د لومړیتوبونو لیست',
    '16': 'د چارت پرمختګ / د سکور پوهه',
    '17': 'د مومېنټ سایکل آف بریالۍ وکاروه',
    '18': 'ډریم بیلډ - د خوب کتاب او لید بورډ',
    '19': 'سیسټم ته نښلول',
    '20': 'د شخصی مهارت ساینس کورس',
    '21': 'د خبرو خیال وساته - څه چې وایې هماغه ترلاسه کوې',
    '22': 'فزیولوژی / د بریا لپاره جامې واغوندئ',
    '23': 'روښانه ضد نیت',
    '24': 'خپل داخلی ځواک راویښ کړه: د سوپر ځواک پروسې',
    '25': 'په الفا-تیتا دماغی څپې خپور شو',
    '26': 'د غم کیسه مه وایه',
    '27': 'مننه / مننه وښیه',
    '28': 'د ناکامۍ عادتونه د بریا عادتونو سره بدل کړئ (چټک کوونکی پروسې)',
    '29': 'یو ماسټرماینډ جوړ کړه',
    '30': 'بریالی خلک/شاګرد وګورئ',
    '31': 'د بریا کیسې واورئ/ولولئ',
    '32': 'لومړی هغه څه ورکړه چې غواړې',
    '33': 'اوس یې وکړه ذهنیت',
    '34': 'خپل بدن ته پام وکړه',
    '35': 'په ستونزو کې طلا پیدا کړئ',
    '36': 'د فیلډ څخه سمسکاراس پاک کړئ',
    '37': '۱۰۰٪ مسؤلیت واخله',
    '38': 'جاذب ساحې جنراتورونه',
    '39': 'یو کلب ته ورشئ چې تاسو د بریښنا سرچینې سره وصل کوی',
    '40': 'ژوند د قصدی نیت سره ژوند کول - په اوسنی وخت کې اوسېدل',
    '1a': 'ته چا ته غوږ نیسې؟',
    '1b': 'د زده کړې وړتیا شاخص',
    '1c': 'د روزنې توازن کچه',
    '1d': 'ناشعوری وړتیا',
    '19a': 'کتابونه ولولئ',
    '19b': 'آډیوګانې واورئ',
    '19c': 'د پیښو ګډون (میاشتنی)',
    '19d': 'ورکړه او ترلاسه کړه پیژندنه / پراخه طلایی قاعده',
    '19e': 'له همفکره خلکو سره اړیکې جوړې کړئ',
    '23a': 'د پیسو پروسې',
    '23b': 'د اړیکو پروسې',
    '23c': 'د مشرتابه پروسې',
    '23d': 'د اړیکو پروسې',
    '23e': 'روغتیایی پروسې',
    '23f': 'د روحانی پوهاوی پروسې',
    '23g': 'د خوب پروسې',
    '23h': 'سازمان او تمرکز پروسې'
  }
};
